...
const UpdateBookModal = ({ isOpen, onClose, onSuccess, bookId }) => {
  ...
  // Populate form when book details load
  useEffect(() => {
    if (bookDetails) {
      setFormData({
  ...
  return (
    <div
      className="update-book-modal-overlay"
      onClick={(e) => {
        if (e.target === e.currentTarget && !isLoading) onClose()
      }}
    >
      <div className="update-book-modal-wrapper">
        {/* Header */}
        <div className="update-book-modal-header">
          <div className="update-book-modal-title">
            <FaBook className="modal-title-icon" />
            <h2>Edit Book</h2>
          </div>
          <button
            className="update-book-modal-close"
            onClick={onClose}
        ...
        <div className="update-book-modal-body">
          {isPageLoading ? (
            ...
            <form onSubmit={handleSubmit} className="update-book-form">
              ...
              {/* Footer inside form */}
              <div className="update-book-modal-footer">
